# Build both arms as standalone torch extensions: _C_their (this PR) and _C_base (upstream at the
...
for name, src, binding, inc in (
    ("_C_their", os.path.join(here, "topk_their.cu"), os.path.join(here, "bindings_their.cpp"), [here]),
):
...
print("det :", torch.ops._C_their.persistent_topk)
