...
- **`RADIX_THRESHOLD = 16384` is GB10-tuned and is not optimal even here — measured, and it is too
  low.** *(Updated 2026-09-08 with a threshold sweep; the earlier text said only that no scalar value
  ...
  16,384 < n ≤ 22,016 is currently sent to a path costing 16–53 % more, worst at 64 rows. **22,016 is
